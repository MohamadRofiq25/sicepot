            ...
            <div class="container">
                <form action="/dashboard/kegiatan" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="name" name="name" required placeholder="Nama Kegiatan..." value="{{ old('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="harga" name="harga" required placeholder="Harga satuan.." value="{{ old('harga') }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="text" id="ba" name="ba" required placeholder="BA.." value="{{ old('ba') }}">
                        </div>
                    </div>
                    <br>
                    <div class="row">
